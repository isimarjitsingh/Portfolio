      ...
      <div className="container mx-auto">
        <div className="text-center" style={{ animation: 'fadeInUp 1s ease-out forwards' }}>
          ...
          <div className="flex items-center justify-center gap-2 mb-8 group">
            ...
            <span className="text-green-500 text-sm font-medium transition-all duration-300 group-hover:text-green-400 group-hover:scale-105">Available for new opportunities</span>
          </div>
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-8 transform transition-all duration-300 hover:text-gray-200">
            B.Tech CSE Student & Frontend Developer
          </p>
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12 transform transition-all duration-300 hover:text-gray-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a href="#projects" className="group bg-gradient-to-r from-purple-600 to-purple-700 text-white px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-all duration-300 inline-flex items-center justify-center gap-2 transform hover:scale-105 hover:shadow-xl hover:shadow-purple-500/50 hover:-translate-y-1">
              Explore My Work
              <svg className="w-5 h-5 transform transition-all duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </a>
            <a href="#contact" className="group border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:-translate-y-1">
              Contact Me
            </a>
          </div>
          ...
          <div className="flex justify-center space-x-6">
            <a 
              ...
              className="group text-gray-400 hover:text-accent transition-all duration-300 transform hover:scale-125 hover:rotate-12"
            >
